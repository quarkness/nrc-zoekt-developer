...
In je CV komen de volgende termen voor: PHP, Python, MySQL, open source, humor, .net Sharepoint en GIT. Niet noodzakelijkerwijs in deze volgorde. Je hebt een relevante afgeronde HBO/WO-opleiding en minimaal 40 jaar ervaring als webontwikkelaar.
